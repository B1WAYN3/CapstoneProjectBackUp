...
def find_servo_range_and_straight(pca, channel, file_path):
    ...
    steering_servo = servo.Servo(pca.channels[channel])
    ...
    try:
        ...
        steering_servo.angle = 0  # Minimum angle
        ...
        steering_servo.angle = 180  # Maximum angle
        time.sleep(2)  # Wait for servo to reach position
        max_position = 180
        ...
        while True:
            steering_servo.angle = straight_angle
            time.sleep(2)
...
if __name__ == "__main__":
    ...
    servo_channel = 14  # Updated channel for the correct servo
